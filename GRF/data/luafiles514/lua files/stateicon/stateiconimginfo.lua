...
StateIconImgList = {
  ...
  [PRIORITY_RED] = {
    ...
    [EFST_IDs.EFST_HANDICAPSTATE_ICEEXPLO] = "┤┘└╠¥ã©¾ÁÕ┤§¢║ã«.TGA",
    [EFST_IDs.EFST_DARKCROW] = "DARKCROW.TGA",
    [EFST_IDs.EFST_REBOUND] = "REBOUND.TGA",
    [EFST_IDs.EFST_CHILL] = "i_starcomfort.tga",
    [EFST_IDs.EFST_BURNT] = "┐└╣÷╚¸ã«.tga",
    [EFST_IDs.EFST_GLASTHEIM_TRANS] = "GLASTHEIM_TRANS.tga",
    [EFST_IDs.EFST_B_TRAP] = "╣┘└╬ÁÕã«Àª.tga",
    [EFST_IDs.EFST_P_ALTER] = "Ã├Àíã╝│Ð¥╦┼═.tga",
    [EFST_IDs.EFST_C_MARKER] = "┼®©▓┴­©Â─┐.tga",
    ...
    [EFST_IDs.EFST_LOCKON_LASER] = "┼®©▓┴­©Â─┐.tga",
    [EFST_IDs.EFST_CLOUD_POISON] = "┼¼Â¾┐ýÁÕ┼│.tga",
    [EFST_IDs.EFST_SPORE_EXPLOSION_DEBUFF] = "¥╚ã╝©┼┼═©«¥¾.tga",
  ...
  [PRIORITY_BLUE] = {
    ...
    [EFST_IDs.EFST_M_LIFEPOTION] = "╝ÊÃ³╗²©Ý╝÷.TGA",
    ...
    [EFST_IDs.EFST_GLASTHEIM_HIDDEN] = "©Â╣²╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_GLASTHEIM_STATE] = "ELDICASTES.TGA",
    [EFST_IDs.EFST_GLASTHEIM_ITEMDEF] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_GLASTHEIM_HPSP] = "gogi.tga",
    [EFST_IDs.EFST_ALMIGHTY] = "¢┼└ÃÂµ.TGA",
    ...
    [EFST_IDs.EFST_2013_VALENTINE1] = "▒█À╬©«¥ã.tga",
    [EFST_IDs.EFST_2013_VALENTINE2] = "gogi.tga",
    [EFST_IDs.EFST_2013_VALENTINE3] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF1] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF2] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF3] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF4] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF5] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF6] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF7] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF8] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF9] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_JITTER_BUFF10] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_CUP_OF_BOZA] = "gogi.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE1] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE2] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE3] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE4] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE5] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE6] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE7] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE8] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE9] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_PACKING_ENVELOPE10] = "╚©║╣À┬ÃÔ╗¾ã¸╝Ã.tga",
    [EFST_IDs.EFST_ZONGZI_POUCH_TRANS] = "UNLIMIT.TGA",
    [EFST_IDs.EFST_OVERSEAEXPUP] = "exp.tga",
    [EFST_IDs.EFST_OVERLAPEXPUP] = "EXP_©╗Â¹ÁÁ_░Ý¥þ└╠─Á.tga",
    [EFST_IDs.EFST_BEEF_RIB_STEW] = "┤Ù╚»┤▄.tga",
    [EFST_IDs.EFST_PORK_RIB_STEW] = "┼┬├╗┤▄.tga",
    ...
    [EFST_IDs.EFST_S_HEALPOTION] = "╝ÊÃ³╗²©Ý╝÷.TGA",
    ...
    [EFST_IDs.EFST_LIMIT_POWER_BOOSTER] = "ã°▒Ô.tga",
    ...
    [EFST_IDs.EFST_CHERRY_BLOSSOM_CAKE] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    ...
    [EFST_IDs.EFST_HELM_VERKANA] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_RHYDO] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_TURISUS] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_HAGALAS] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_ISIA] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_ASIR] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_HELM_URJ] = "╣░©«╣µ¥¯ã¸╝Ã.TGA",
    [EFST_IDs.EFST_PERIOD_RECEIVEITEM] = "item.tga",
    [EFST_IDs.EFST_PERIOD_PLUSJOBEXP] = "job.tga",
    [EFST_IDs.EFST_PERIOD_PLUSEXP] = "exp.tga",
    [EFST_IDs.EFST_DORAM_BUF_01] = "╝ÊÃ³╗²©Ý╝÷.TGA",
    [EFST_IDs.EFST_DORAM_BUF_02] = "╝ÊÃ³╗²©Ý╝÷.TGA",
    ...
    [EFST_IDs.EFST_PHARAOH_CARD] = "┤Ù╚»┤▄.tga",
    [EFST_IDs.EFST_KIEL_CARD] = "┼┬├╗┤▄.tga",
    ...
    [EFST_IDs.EFST_SPECIALCOOKIE] = "¢┼└ÃÂµ.TGA",
    ...
    [EFST_IDs.EFST_ASPD_POPCORN] = "░°╝Ë╣░¥Ó.TGA",
    [EFST_IDs.EFST_ULTIMATECOOK] = "¢┼└ÃÂµ.TGA",
    ...
    [EFST_IDs.EFST_OVERLAPEXPUP2] = "EXP_©╗Â¹ÁÁ_░Ý¥þ└╠─Á.tga",
  ...
  [PRIORITY_WHITE] = {
    ...
    [EFST_IDs.EFST_E_CHAIN] = "└╠┼═│╬├╝└╬.tga",
    [EFST_IDs.EFST_HEAT_BARREL] = "╚¸ã«╣ÞÀ▓.tga",
    [EFST_IDs.EFST_ANTI_M_BLAST] = "¥╚ã╝©┼┼═©«¥¾.tga",
    ...
    [EFST_IDs.EFST_S_MANAPOTION] = "┤Ù╚»┤▄.TGA",
    [EFST_IDs.EFST_M_DEFSCROLL] = "Ã├Àíã╝│Ð¥╦┼═.TGA",
    [EFST_IDs.EFST_OVERSEA_BUFF_12] = "Ã├Àíã╝│Ð¥╦┼═.TGA",
    ...
    [EFST_IDs.EFST_WEAPONBLOCK_ON] = "┐■ã¨║ÝÀ╬┼À.tga",
    ...
    [EFST_IDs.EFST_MOONLIT_SERENADE] = "┤Ì║¹└Ã╝╝À╣│¬ÁÑ.tga",
    ...
    [EFST_IDs.EFST_MAGICPOWER] = "©Â╣²À┬┴§ã°.TGA",
    [EFST_IDs.EFST_RAISINGDRAGON] = "└ßÀµ¢┬├Á.TGA",
