...
InsertEmotionMsgListTable(ET_DELIGHT, "/ñí")
...
InsertEmotionMsgListTable(ET_THANKS, "/ñú")
...
InsertEmotionMsgListTable(ET_SMILE, "/Ã¤Ã¤")
InsertEmotionMsgListTable(ET_SMILE, "/ñÀ")
...
InsertEmotionMsgListTable(ET_BEST, "/ñ║")
...
InsertEmotionMsgListTable(ET_HUK, "/ñ¥")
...
InsertEmotionMsgListTable(ET_HELP, "/ñ║ñ║")
...
InsertEmotionMsgListTable(ET_KIK, "/ñ╗")
InsertEmotionMsgListTable(ET_KIK, "/─╔─╔")
...
InsertEmotionMsgListTable(ET_STARE, "/ñ╣")
...
InsertEmotionMsgListTable(ET_SPTIME, "/┐Ñ")
...
InsertEmotionMsgListTable(ET_SLEEPY, "/ñ©")
...
InsertEmotionMsgListTable(ET_CONGRATULATION, "/ñ║ñ╗")
...
InsertEmotionMsgListTable(ET_HPTIME, "/ÃÃ")
...
InsertEmotionMsgListTable(ET_OHNO, "/ÃÐ╝¹")
...
InsertEmotionMsgListTable(ET_BLABLA, "/¢├▓°¢├▓°")
...
InsertEmotionMsgListTable(ET_ROCK, "/╣┘└º")
...
InsertEmotionMsgListTable(ET_HUM2, "/╚ý")
...
InsertEmotionMsgListTable(ET_SPIT, "/└í")
...
InsertEmotionMsgListTable(ET_ENE, "/┼╗À┬")
...
InsertEmotionMsgListTable(ET_PANIC, "/░°╚▓")
...
InsertEmotionMsgListTable(ET_WHISP, "/└º¢║ã█")
