...
WeaponNameTable = {
  ...
  [Weapon_IDs.WEAPONTYPE_SHORTSWORD] = "_┤▄░╦",
  [Weapon_IDs.WEAPONTYPE_SWORD] = "_░╦",
  [Weapon_IDs.WEAPONTYPE_TWOHANDSWORD] = "_¥þ╝ı░╦",
  [Weapon_IDs.WEAPONTYPE_SPEAR] = "_├ó",
  [Weapon_IDs.WEAPONTYPE_TWOHANDSPEAR] = "_¥þ╝ı├ó",
  [Weapon_IDs.WEAPONTYPE_AXE] = "_ÁÁ│ó",
  [Weapon_IDs.WEAPONTYPE_TWOHANDAXE] = "_¥þ╝ıÁÁ│ó",
  [Weapon_IDs.WEAPONTYPE_MACE] = "_┼¼À┤",
  [Weapon_IDs.WEAPONTYPE_TWOHANDMACE] = "_┼¼À┤",
  [Weapon_IDs.WEAPONTYPE_ROD] = "_ÀÈÁÕ",
  [Weapon_IDs.WEAPONTYPE_BOW] = "_╚░",
  [Weapon_IDs.WEAPONTYPE_KNUKLE] = "_│╩┼¼",
  [Weapon_IDs.WEAPONTYPE_INSTRUMENT] = "_¥Ã▒Ô",
  [Weapon_IDs.WEAPONTYPE_WHIP] = "_├ñ┬´",
  [Weapon_IDs.WEAPONTYPE_BOOK] = "_├Ñ",
  [Weapon_IDs.WEAPONTYPE_CATARRH] = "_─½┼©©ú_─½┼©©ú",
  [Weapon_IDs.WPCLASS_GUN_HANDGUN] = "_▒Ã├Ð",
  [Weapon_IDs.WPCLASS_GUN_RIFLE] = "_Â¾└╠Ã├",
  [Weapon_IDs.WPCLASS_GUN_GATLING] = "_▒Ô░³├Ð",
  [Weapon_IDs.WPCLASS_GUN_SHOTGUN] = "_╝ª░Ã",
  [Weapon_IDs.WPCLASS_GUN_GRANADE] = "_╝ª░Ã",
  [Weapon_IDs.WPCLASS_SYURIKEN] = "_╝÷©«░╦",
  [Weapon_IDs.WPCLASS_TWOHANDROD] = "_ÀÈÁÕ",
  [Weapon_IDs.WEAPONTYPE_SHORTSWORD_SHORTSWORD] = "_┤▄░╦_┤▄░╦",
  [Weapon_IDs.WEAPONTYPE_SWORD_SWORD] = "_░╦_░╦",
  [Weapon_IDs.WEAPONTYPE_AXE_AXE] = "_ÁÁ│ó_ÁÁ│ó",
  [Weapon_IDs.WEAPONTYPE_SHORTSWORD_SWORD] = "_┤▄░╦_░╦",
  [Weapon_IDs.WEAPONTYPE_SHORTSWORD_AXE] = "_┤▄░╦_ÁÁ│ó",
  [Weapon_IDs.WEAPONTYPE_SWORD_AXE] = "_░╦_ÁÁ│ó",
  ...
  [Weapon_IDs.WEAPONTYPE_FOXTAIL_BROWN] = "_░¡¥ã┴÷Ã«_░Ñ╗÷",
  [Weapon_IDs.WEAPONTYPE_FOXTAIL_GREEN] = "_░¡¥ã┴÷Ã«_│ý╗÷",
  [Weapon_IDs.WEAPONTYPE_CandyCaneRod] = "_─ÁÁ­─╔└╬ÀÈÁÕ",
  [Weapon_IDs.WEAPONTYPE_FOXTAIL_METAL] = "_░¡¥ã┴÷Ã«_©Ì┼╗",
...
WeaponHitWaveNameTable = {
  ...
  [Weapon_IDs.WPCLASS_GUN_HANDGUN] = "_hit_▒Ã├Ð.wav",
  [Weapon_IDs.WPCLASS_GUN_RIFLE] = "_hit_Â¾└╠Ã├.wav",
  [Weapon_IDs.WPCLASS_GUN_GATLING] = "_hit_░│ã▓©ÁÃÐ╣▀.wav",
  [Weapon_IDs.WPCLASS_GUN_SHOTGUN] = "_hit_╝ª░Ã.wav",
  [Weapon_IDs.WPCLASS_GUN_GRANADE] = "_hit_▒ÎÀ╣│Î└╠ÁÕÀ▒├─.wav",
