...
if tblLapineDdukddakBox_data then
	for k, v in pairs(tblLapineDdukddakBox_data) do
		tblLapineDdukddakBox[k] = v
	end
end
if tblLapineDdukddakBox_string then
	for k, v in pairs(tblLapineDdukddakBox_string) do
		if tblLapineDdukddakBox[k] then
			MergeTables(tblLapineDdukddakBox[k], v)
		end
	end
end
