...
tblLapineUpgradeBox = {}
if tblLapineUpgradeBox_data then
	for k, v in pairs(tblLapineUpgradeBox_data) do
		tblLapineUpgradeBox[k] = v
	end
end
if tblLapineUpgradeBox_string then
	for k, v in pairs(tblLapineUpgradeBox_string) do
		if tblLapineUpgradeBox[k] then
			MergeTables(tblLapineUpgradeBox[k], v)
		end
	end
end
