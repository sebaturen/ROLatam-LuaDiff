...
RIDING_SPRITE_INHERIT_LIST = 
{
	...
	[JOBID.JT_FROG_LINKER_B] = JOBID.JT_PORING_NOVICE,
	[JOBID.JT_PECO_GUNNER_B] = JOBID.JT_PORING_NOVICE,
	[JOBID.JT_PECO_REBELLION_B] = JOBID.JT_PORING_NOVICE,
	[JOBID.JT_STAR2_B] = JOBID.JT_STAR,
...
function	GetSpriteInheriteJob(jobID)
	if RIDING_SPRITE_INHERIT_LIST ~= nil then
		if RIDING_SPRITE_INHERIT_LIST[jobID] ~= nil then
			jobID = RIDING_SPRITE_INHERIT_LIST[jobID]
		end
	end
	
	if JOB_INHERIT_LIST2 ~= nil then
		if JOB_INHERIT_LIST2[jobID] ~= nil then
			jobID = JOB_INHERIT_LIST2[jobID]
		end
	end
	
	if SPRITE_INHERIT_LIST ~= nil then
		if SPRITE_INHERIT_LIST[jobID] ~= nil then
	...
	if ( sizeType == LAYER_BIG ) then
		if EXCEPTION_SPRITE_INHERIT_LIST ~= nil then
			if EXCEPTION_SPRITE_INHERIT_LIST[jobID] ~= nil then
